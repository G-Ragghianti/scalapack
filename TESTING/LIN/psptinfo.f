      SUBROUTINE PSPTINFO( SUMMRY, NOUT, UPLO, NMAT, NVAL, LDNVAL, NBW,
...
*  =======
*
*  PSPTINFO get needed startup information for band factorization
...
*     .. External Subroutines ..
     ...
     $                   IGEBS2D, SGEBR2D, SGEBS2D, IGEBSS, IGEBRS
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
      REAL               PSLAMCH
...
*
     ...
     $                   'real single precision band matrix solve '
         WRITE( NOUT, FMT = 9999 )
